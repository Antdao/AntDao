...
contract AntsToken is IAntToken, AccessControl, ERC20 {
    ...
    function mint(address _to, uint256 _amount) public  {
        require(hasRole(MINTER_ROLE, _msgSender()), "AntsToken: must have minter role to mint");
        _mint(_to, _amount);
         }
        ...
        external
    {
        ...
        require(nonce == sigNonces[signatory]++, "ANT::delegateBySig: invalid nonce");
